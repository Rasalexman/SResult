...
abstract class BaseResultFragment<VM : IResultViewModel> : Fragment(), IBaseFragment<VM>, INavigationHandler {
    ...
    abstract fun addViewModelObservers(vm: IResultViewModel?)
